...
<div class="jumbotron" style="background-color: white; margin-top: 100px;">
	<div class="container">
		<div class="row" style="text-align: center;">
			...
			{{-- <div class="col-md-4">
				<h3>EXPERIENCE</h3>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima amet possimus ducimus fugit architecto maxime quibusdam, quaerat saepe ea, dolores iusto, inventore tenetur eius quidem fugiat voluptatibus? Soluta, voluptas, eum.</p>
			</div>
			<div class="col-md-4">
				<h3>PERFECT</h3>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima amet possimus ducimus fugit architecto maxime quibusdam, quaerat saepe ea, dolores iusto, inventore tenetur eius quidem fugiat voluptatibus? Soluta, voluptas, eum.</p>
